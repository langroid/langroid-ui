...
# Run the Langroid Chat UI with the callback-based backend

echo "🚀 Starting Langroid Chat UI with Callback-Based Backend..."
echo ""
...
# Start backend with callbacks
echo -e "${BLUE}Starting callback-based backend server...${NC}"
cd backend
...
echo ""
echo -e "${GREEN}✅ Langroid Chat UI (with Callbacks) is running!${NC}"
echo ""
...
echo ""
echo -e "${YELLOW}ℹ️  This is using the callback-based backend implementation${NC}"
echo ""
